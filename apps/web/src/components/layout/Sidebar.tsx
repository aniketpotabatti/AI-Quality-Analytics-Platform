  ...
  return (
    <aside className="sidebar">
      ...
      <nav style={{ padding: "1rem 0.75rem", flex: 1 }}>
        <div style={{ marginBottom: "0.375rem", fontSize: "0.6875rem", fontWeight: 600, color: "var(--text-muted)", textTransform: "uppercase", letterSpacing: "0.08em", padding: "0 0.25rem", marginTop: "0.5rem" }}>
          Main
        </div>
        {navItems.map((item) => {
        ...
        <div style={{ marginBottom: "0.375rem", marginTop: "1.5rem", fontSize: "0.6875rem", fontWeight: 600, color: "var(--text-muted)", textTransform: "uppercase", letterSpacing: "0.08em", padding: "0 0.25rem" }}>
          Settings
        </div>
        <Link
          href="/settings"
